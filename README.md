**"Bitboard Chess Engine Made By Maxim Korzh Tutorial.c"** is a bitboard chess engine made in accordance with the tutorial of Maxim Korzh https://www.youtube.com/watch?v=QUNP-UjujBM&list=PLmN0neTso3Jxh8ZIylk74JpwfiWNI76Cs . I've completed 80 videos out of 95.

**"Read Pasted Text Word by Word.html"** is a tool that reads pasted text word by word. I use it in working with texts when I want to fully focus on some part of the text and not get distracted or overwhelmed by the rest ot it. 
